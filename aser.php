...
//$html = file_get_html('http://www.wvmp360.com/index.asp?uid=18913590691&brand=');

    $urls='http://www.wvmp360.com/news.asp?news.asp?uid=18913590691&cid=101&keys=&brand=&page=1';
    $html = file_get_html($urls);

// Find all links
foreach($html->find('div[class=newmk_list_new]') as $element) {
